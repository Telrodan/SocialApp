...
const sidebar = () => {
  ...
  const template = `
      ...
      <a href="/src/pages/news.html?page=1" class="sidebar__link"><i class="fa-solid fa-newspaper fa-fw sidebar__icon"></i> News</a>
      <a href="/src/pages/messages/messages.html" class="sidebar__link"><i class="fa-solid fa-message fa-fw sidebar__icon"></i> Messages</a>
